   ...
   {{--  <section class="b-featured">
            ...
            <div id="carousel-small" class="owl-carousel enable-owl-carousel" data-items="4" data-navigation="true" data-auto-play="true" data-stop-on-hover="true" data-items-desktop="4" data-items-desktop-small="4" data-items-tablet="3" data-items-tablet-small="2">
                <div>
                    <div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
                        <a href="detail.html">
                            <img src="{{ URL::asset('public/frontend//media/186x113/mers.jpg') }}" alt="mers" />
                ...
                <div>
                    <div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
                        <a href="detail.html">
                            <img src="{{ URL::asset('public/frontend//media/186x113/audi.jpg') }}" alt="audi" />
                        </a>
                        <div class="b-featured__item-price">
                            $95,900
                        </div>
                ...
                <div>
                    <div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
                        <a href="detail.html">
                            <img src="{{ URL::asset('public/frontend//media/186x113/aston.jpg') }}" alt="aston" />
                ...
                <div>
                    <div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
                        <a href="detail.html">
                            <img src="{{ URL::asset('public/frontend//media/186x113/jaguar.jpg') }}" alt="jaguar" />
                        </a>
                        <div class="b-featured__item-price">
                            $130,825
                        </div>
            ...
            <div class="row">
                <div class="col-sm-4 col-xs-12">
                    <div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                        <img class="img-responsive" src="{{ URL::asset('public/frontend//media/370x200/wolks.jpg') }}" alt="wolks" />
                ...
                <div class="col-sm-4 col-xs-12">
                    <div class="b-world__item wow zoomInUp" data-wow-delay="0.3s" data-wow-offset="100">
                        <img class="img-responsive" src="{{ URL::asset('public/frontend//media/370x200/mazda.jpg') }}" alt="mazda" />
                        <div class="b-world__item-val">
                ...
                <div class="col-sm-4 col-xs-12">
                    <div class="b-world__item j-item wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">
                        <img class="img-responsive" src="{{ URL::asset('public/frontend//media/370x200/chevrolet.jpg') }}" alt="chevrolet" />
                        <div class="b-world__item-val">
    ...
    <section class="b-review">
        ...
        <img src="{{ URL::asset('public/frontend//images/backgrounds/reviews.jpg') }}" alt="" class="img-responsive center-block" />
    </section>
    <!--b-review-->
