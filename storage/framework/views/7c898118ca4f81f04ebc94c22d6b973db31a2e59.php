...
<?php echo __('cms::strings.categories_list'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('member::common-components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title_li'); ?>
            <?php if(auth()->user()->isAn('ROOT') or auth()->user()->can('CREATE_CATEGORY')): ?>
                <a href="<?php echo route('cms::categories.create'); ?>" class="btn btn-warning">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title"><?php echo __('cms::strings.categories_list'); ?></h4>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(__('cms::strings.code')); ?></th>
...
<?php echo $__env->make('member::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u587692534/domains/almaknon.com/public_html/Modules/CMS/Resources/views/categories/index.blade.php ENDPATH**/ ?>