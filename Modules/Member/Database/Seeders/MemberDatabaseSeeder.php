...
class MemberDatabaseSeeder extends Seeder
{
    ...
    protected function SeedUsersPermissions()
    {
        ...
        $this->data['USERS_ABILITY_GROUP']->{'description:en'} = 'Test Users Management Description';
