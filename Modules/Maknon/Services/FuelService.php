...
class FuelService extends BaseService
{
    ...
    public function getModel($id, ...$relations)
    {
        ...
        if (auth()->user()->isAn('ROOT') or auth()->user()->can('RESTORE_FUELS'))
            $this->data['model']->withTrashed();

        if (auth()->user()->isAn('ROOT') or auth()->user()->can('STATUS_UPDATE_FUELS'))
    ...
    public function store($data)
    {
        ...
        return $this->response(200, [], null, route('fuels.index'));
    }
    ...
    public function update($id, $data)
    {
        ...
        return $this->response(200, [], null,route('fuels.update', ['model' => $id]));  
    }
