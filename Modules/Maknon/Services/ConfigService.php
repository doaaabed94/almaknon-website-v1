...
class ConfigService extends BaseService
{
    ...
    public function getModel($id, ...$relations)
    {
        ...
        if (auth()->user()->isAn('ROOT') or auth()->user()->can('RESTORE_CONFIG'))
            $this->data['model']->withTrashed();

        if (auth()->user()->isAn('ROOT') or auth()->user()->can('STATUS_UPDATE_CONFIG'))
    ...
    public function index()
    {
        ...
        $this->data['ALL_MODEL_DATA_'] = $this->data['ALL_MODEL_DATA_']->get();
    ...
    public function store($data)
    {
        ...
        return $this->response(200, [], null, route('configs.index'));
    }
    ...
    public function update($id, $data)
    {
        ...
        $this->data['model']->value                         = $this->data['update_data']['value'];
        $this->data['model']->created_by                    = $this->data['currentUser']->id;
        $this->data['model']->save();
