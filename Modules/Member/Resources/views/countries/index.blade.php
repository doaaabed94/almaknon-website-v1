    ...
    @component('member::common-components.breadcrumb')
        ...
        @slot('title_li')
            @if (auth()->user()->isAn('ROOT') or auth()->user()->can('CREATE_COUNTRIES'))
                <a href="{!! route('member::CountryController@create') !!}" class="btn btn-warning">
                                ...
                                <tr>
                                    ...
                                    <td>
                                      @include('member::common-components.action_datatable', [
                                        ...
                                        'delete_url' => route('member::CountryController@postDelete', ['model' => $data->id]) ,
                                        'restore_url' => route('member::CountryController@postRestore', ['model' => $data->id]) ,
                                        'update_url' => route('member::CountryController@update', ['model' => $data->id]),
                                        'permdelete_url' => route('member::CountryController@postPermaDelete', ['model' => $data->id]),
                                        'status_url' => route('member::CountryController@postStatus', ['model' => $data->id]),
                                        ])
                                    </td>
                                </tr>
                            @endforeach
