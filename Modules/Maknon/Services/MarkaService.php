...
class MarkaService extends BaseService
{
    ...
    public function getModel($id, ...$relations)
    {
        ...
        if (auth()->user()->isAn('ROOT') or auth()->user()->can('RESTORE_MARKAS'))
            $this->data['model']->withTrashed();

        if (auth()->user()->isAn('ROOT') or auth()->user()->can('STATUS_UPDATE_MARKAS'))
    ...
    public function store($data)
    {
        ...
        return $this->response(200, [], null, route('markas.index'));
    }
    ...
    public function update($id, $data)
    {
        ...
        return $this->response(200, [], null,route('markas.update', ['model' => $id]));  
    }
