<?php $__env->startSection('title'); ?>
    <?php echo __('maknon::main.markas_list'); ?> - <?php echo __('member::strings.add_new'); ?>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="crud-ajax-form needs-validation action-ajax-form" action="#" method="POST">
                        ...
                        <?php if($CurrentUser->can('STATUS_UPDATE_MARKA') or $CurrentUser->isAn('ROOT')): ?>
                            <?php echo $__env->make(
                        ...
                        <div class="col-lg-2 col-xl-2 m-auto d-flex mt-5">
                            ...
                            <a href="<?php echo e(route('markas.index')); ?>" class="btn btn-success btn-back mr-2 ml-2 mt-5 w-50">
...
<?php echo $__env->make('member::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u587692534/domains/almaknon.com/public_html/Modules/Maknon/Resources/views/markas/create.blade.php ENDPATH**/ ?>