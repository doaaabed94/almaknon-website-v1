...
<?php echo __('cms::strings.content'); ?> - <?php echo __('member::strings.add_new'); ?>
...
<a href="<?php echo e(route('cms::contents.index')); ?>">
    <?php echo __('cms::strings.content'); ?>
            ...
            <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php echo e($_LOCALE_BASE_CODE == $locale ? 'active' : ''); ?> lang_tab_<?php echo e($_LOCALE_BASE_CODE); ?>" data-toggle="tab" href="#kt_tabs_<?php echo e($_LOCALE_BASE_CODE); ?>">
                                        <img alt="" src="<?php echo e(\Module::asset('member:images/flags/' . $_LOCALE_BASE_CODE . '.jpg')); ?>" style="width: 20px;">
                ...
                <?php echo $__env->make('member::common-components.inputs.text', [
                    ...
                    <div class="col-lg-2 col-xl-2 m-auto d-flex mt-5">
                        <a class="btn btn-success btn-back mr-2 ml-2 mt-5 w-50" href="<?php echo e(route('cms::contents.index')); ?>">
...
<?php echo $__env->make('member::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u587692534/domains/almaknon.com/public_html/Modules/CMS/Resources/views/contents/create.blade.php ENDPATH**/ ?>