...
<?php $__env->startSection('title'); ?>
    <?php echo __('member::strings.countries'); ?> - <?php echo __('member::strings.update'); ?>
...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('member::common-components.breadcrumb'); ?>
        ...
        <?php $__env->endSlot(); ?>
        <?php $__env->slot('li_1'); ?>
            <?php echo __('member::strings.update'); ?>
   ...
   <div class="row">
        <div class="col-12">
            <div class="card">
                    <h4 class="card-title"><?php echo __('member::strings.update'); ?></h4>
                
                <div class="card-body">
                    <form  class="crud-ajax-form needs-validation action-ajax-form" action="<?php echo route('member::countries.postUpdate', ['model' => $model->id]); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('member::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u587692534/domains/almaknon.com/public_html/Modules/Member/Resources/views/countries/update.blade.php ENDPATH**/ ?>