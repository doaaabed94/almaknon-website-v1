...
class OfferService extends BaseService
{
    ...
    public function getModel($id, ...$relations)
    {
        ...
        if (auth()->user()->isAn('ROOT') or auth()->user()->can('RESTORE_OFFERS'))
            $this->data['model']->withTrashed();

        if (auth()->user()->isAn('ROOT') or auth()->user()->can('STATUS_UPDATE_OFFERS'))
    ...
    public function store($data)
    {
        ...
        return $this->response(200, [], null, route('offers.index'));
    }
    ...
    public function update($id, $data)
    {
        ...
        return $this->response(200, [], null,route('offers.update', ['model' => $id]));  
    }
