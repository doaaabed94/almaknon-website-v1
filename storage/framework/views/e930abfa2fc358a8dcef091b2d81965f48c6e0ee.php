...
<?php echo __('maknon::main.colors_list'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('member::common-components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title_li'); ?>
            <?php if(auth()->user()->isAn('ROOT') or auth()->user()->can('CREATE_color')): ?>
                <a href="<?php echo route('colors.create'); ?>" class="btn btn-warning">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title"><?php echo __('maknon::main.colors_list'); ?></h4>
...
<?php echo $__env->make('member::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u587692534/domains/almaknon.com/public_html/Modules/Maknon/Resources/views/colors/index.blade.php ENDPATH**/ ?>