...
class MarkaController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('NeedPermissions:READ_MARKA')->only(['index', 'postIndex', 'read']);
        $this->middleware('NeedPermissions:CREATE_MARKA')->only(['create', 'postCreate']);
        $this->middleware('NeedPermissions:UPDATE_MARKA')->only(['update', 'postUpdate']);
        $this->middleware('NeedPermissions:DELETE_MARKA')->only(['postDelete']);
        $this->middleware('NeedPermissions:RESTORE_MARKA')->only(['postRestore']);
        $this->middleware('NeedPermissions:PERMA_DELETE_MARKA')->only(['postPermaDelete']);
        $this->middleware('NeedPermissions:STATUS_UPDATE_MARKA')->only(['postStatus']);
