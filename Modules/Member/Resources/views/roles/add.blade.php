...
@section('title')
{!! __('member::strings.roles') !!} - {!! __('member::strings.create_new_role') !!}
@endsection
...
@endslot
@slot('li_1')
{!! __('member::strings.create_new_role') !!}
@endslot
@endcomponent
...
<div class="card">
    <div class="card-body">
        <h4 class="card-title mt-2 mb-3">{!! __('member::strings.create_new_role') !!}</h4>
        <form  class="crud-ajax-form needs-validation action-ajax-form" action="{!! route('member::roles.postCreate') !!}" method="POST">
            {!! csrf_field() !!}
