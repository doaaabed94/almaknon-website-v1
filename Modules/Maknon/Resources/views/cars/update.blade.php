...
@section('title')
    {!! __('main.degrees_list') !!} - {!! __('member::strings.add_new') !!}
@endsection

@section('content')
    @component('member::common-components.breadcrumb')
        @slot('title')
        <a href="{{ route('degrees.index') }}" > {!! __('main.degrees_list') !!} </a>
        @endslot
        @slot('li_1')
                ...
                <div class="card-body">
                    ...
                    <form class="crud-ajax-form needs-validation action-ajax-form" action="#" method="POST">
                        ...
                        <div class="col-lg-2 col-xl-2 m-auto d-flex mt-5">
                            ...
                            <a href="{{ route('degrees.index') }}" class="btn btn-success btn-back mr-2 ml-2 mt-5 w-50">
