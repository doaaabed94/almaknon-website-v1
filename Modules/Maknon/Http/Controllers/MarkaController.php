...
use Modules\Maknon\Services\MarkaService;
...
class MarkaController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('NeedPermissions:READ_MARKAS')->only(['index', 'postIndex', 'read']);
        $this->middleware('NeedPermissions:CREATE_MARKAS')->only(['create', 'postCreate']);
        $this->middleware('NeedPermissions:UPDATE_MARKAS')->only(['update', 'postUpdate']);
        $this->middleware('NeedPermissions:DELETE_MARKAS')->only(['postDelete']);
        $this->middleware('NeedPermissions:RESTORE_MARKAS')->only(['postRestore']);
        $this->middleware('NeedPermissions:PERMA_DELETE_MARKAS')->only(['postPermaDelete']);
        $this->middleware('NeedPermissions:STATUS_UPDATE_MARKAS')->only(['postStatus']);

        $this->service = new MarkaService();
        $this->validationsRules = $this->service->validationsRules;
        $this->data['model'] = Marka::query();
    }

    public function index(Request $request)
    {
        $this->data['all_data'] = $this->service->index();
        return view('maknon::markas.index', $this->data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('maknon::markas.create', $this->data);
    }
    ...
    public function update(Request $request)
    {
        ...
        return view('maknon::markas.update', $this->data);
    }
    ...
    public function read(Request $request)
    {
        ...
        return view('maknon::markas.read', $this->data);
    }
}
