...
Route::prefix('dashboard')->name('member::')->group(function () {
    ...
    Route::prefix('countries')->group(function() {
        ...
        Route::post('/'                    , 'CountryController@postIndex')->name('CountryController@postIndex');
        Route::get('list'                  , 'CountryController@ajaxList')->name('CountryController@ajaxList');
        Route::get('create'                , 'CountryController@create')->name('CountryController@create');
        Route::post('create'               , 'CountryController@postCreate')->name('CountryController@postCreate');
        Route::get('{model}/update'        , 'CountryController@update')->name('CountryController@update');
        Route::post('{model}/update'       , 'CountryController@postUpdate')->name('CountryController@postUpdate');
        Route::post('{model}/delete'       , 'CountryController@postDelete')->name('CountryController@postDelete');
        Route::post('{model}/restore'      , 'CountryController@postRestore')->name('CountryController@postRestore');
        Route::post('{model}/perma-delete' , 'CountryController@postPermaDelete')->name('CountryController@postPermaDelete');
        Route::post('{model}/toggle-status', 'CountryController@postStatus')->name('CountryController@postStatus');
        Route::get('{model}'               , 'CountryController@read')->name('CountryController@read');
    });
