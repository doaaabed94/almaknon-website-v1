...
class DegreeService extends BaseService
{
    ...
    public function getModel($id, ...$relations)
    {
        ...
        if (auth()->user()->isAn('ROOT') or auth()->user()->can('RESTORE_DEGREES'))
            $this->data['model']->withTrashed();

        if (auth()->user()->isAn('ROOT') or auth()->user()->can('STATUS_UPDATE_DEGREES'))
    ...
    public function store($data)
    {
        ...
        return $this->response(200, [], null, route('degrees.index'));
    }
    ...
    public function update($id, $data)
    {
        ...
        return $this->response(200, [], null,route('degrees.update', ['model' => $id]));  
    }
