...
use Modules\CMS\Entities\Condition;
...
class SubCategoryService extends BaseService
{
    ...
    public function getModel($id, ...$relations)
    {
        ...
        if (auth()->user()->isAn('ROOT') or auth()->user()->can('RESTORE_CONDITIONS'))
            $this->data['model']->withTrashed();

        if (auth()->user()->isAn('ROOT') or auth()->user()->can('STATUS_UPDATE_CONDITIONS'))
    ...
    public function store($data)
    {
        ...
        return $this->response(200, [], null, route('conditions.index'));
    }
    ...
    public function update($id, $data)
    {
        ...
        return $this->response(200, [], null,route('conditions.update', ['model' => $id]));  
    }
