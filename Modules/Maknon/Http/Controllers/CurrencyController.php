...
use Modules\Maknon\Services\CurrencyService;
...
class CurrencyController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('NeedPermissions:READ_CURRENCY')->only(['index', 'postIndex', 'read']);
        $this->middleware('NeedPermissions:CREATE_CURRENCY')->only(['create', 'postCreate']);
        $this->middleware('NeedPermissions:UPDATE_CURRENCY')->only(['update', 'postUpdate']);
        $this->middleware('NeedPermissions:DELETE_CURRENCY')->only(['postDelete']);
        $this->middleware('NeedPermissions:RESTORE_CURRENCY')->only(['postRestore']);
        $this->middleware('NeedPermissions:PERMA_DELETE_CURRENCY')->only(['postPermaDelete']);
        $this->middleware('NeedPermissions:STATUS_UPDATE_CURRENCY')->only(['postStatus']);

        $this->service = new CurrencyService();
        $this->validationsRules = $this->service->validationsRules;
        $this->data['model'] = Currency::query();
    }

    public function index(Request $request)
    {
        $this->data['all_data'] = $this->service->index();
        return view('maknon::currency.index', $this->data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('maknon::currency.create', $this->data);
    }
    ...
    public function update(Request $request)
    {
        ...
        return view('maknon::currency.update', $this->data);
    }
    ...
    public function read(Request $request)
    {
        ...
        return view('maknon::currency.read', $this->data);
    }
}
