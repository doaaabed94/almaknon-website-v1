...
use Modules\Maknon\Services\OfferService;
...
class OfferController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('NeedPermissions:READ_OFFERS')->only(['index', 'postIndex', 'read']);
        $this->middleware('NeedPermissions:CREATE_OFFERS')->only(['create', 'postCreate']);
        $this->middleware('NeedPermissions:UPDATE_OFFERS')->only(['update', 'postUpdate']);
        $this->middleware('NeedPermissions:DELETE_OFFERS')->only(['postDelete']);
        $this->middleware('NeedPermissions:RESTORE_OFFERS')->only(['postRestore']);
        $this->middleware('NeedPermissions:PERMA_DELETE_OFFERS')->only(['postPermaDelete']);
        $this->middleware('NeedPermissions:STATUS_UPDATE_OFFERS')->only(['postStatus']);

        $this->service = new OfferService();
        $this->validationsRules = $this->service->validationsRules;
        $this->data['model'] = Offer::query();
    }

    public function index(Request $request)
    {
        $this->data['all_data'] = $this->service->index();
        return view('maknon::offers.index', $this->data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('maknon::offers.create', $this->data);
    }
    ...
    public function update(Request $request)
    {
        ...
        return view('maknon::offers.update', $this->data);
    }
    ...
    public function read(Request $request)
    {
        ...
        return view('maknon::offers.read', $this->data);
    }
}
