...
class CategoryService extends BaseService
{
    ...
    public function getModel($id, ...$relations)
    {
        ...
        if (auth()->user()->isAn('ROOT') or auth()->user()->can('RESTORE_CATEGORY')) {
            $this->data['model']->withTrashed();
        }

        if (auth()->user()->isAn('ROOT') or auth()->user()->can('STATUS_UPDATE_CATEGORY')) {
    ...
    public function store($data)
    {
        ...
        return $this->response(200, [], null, route('cms::categories.index'));
    }
    ...
    public function update($id, $data)
    {
        ...
        return $this->response(200, [], null, route('cms::categories.update', ['model' => $id]));
    }
