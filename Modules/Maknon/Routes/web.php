...
Route::prefix('dashboard')->group(function () {
    ...
    Route::prefix('cars')->group(function () {
        ...
        Route::get('{model}/evaluation', 'CarController@evaluation')->name('cars.evaluation');
        Route::get('{model}/favourite', 'CarController@favourite')->name('cars.favourite');
        Route::post('{model}/toggle-status-favourite', 'CarController@postStatusFavourite')->name('cars.postStatusFavourite');
        Route::post('{model}/toggle-status-evaluation', 'CarController@postStatusEvaluation')->name('cars.postStatusEvaluation');
