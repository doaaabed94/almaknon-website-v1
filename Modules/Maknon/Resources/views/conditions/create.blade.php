...
@section('title')
    {!! __('maknon::main.conditions_list') !!} - {!! __('member::strings.add_new') !!}
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="crud-ajax-form needs-validation action-ajax-form" action="#" method="POST">
                        ...
                        @if ($CurrentUser->can('STATUS_UPDATE_MARKAS') or $CurrentUser->isAn('ROOT'))
                            @include(
                        ...
                        <div class="col-lg-2 col-xl-2 m-auto d-flex mt-5">
                            ...
                            <a href="{{ route('conditions.index') }}" class="btn btn-success btn-back mr-2 ml-2 mt-5 w-50">
