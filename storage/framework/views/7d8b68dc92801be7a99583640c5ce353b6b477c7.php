...
<?php echo __('member::strings.roles'); ?> - <?php echo __('member::strings.create_new_role'); ?>
...
<?php $__env->endSlot(); ?>
<?php $__env->slot('li_1'); ?>
<?php echo __('member::strings.create_new_role'); ?>
...
<div class="card">
    <div class="card-body">
        <h4 class="card-title mt-2 mb-3"><?php echo __('member::strings.create_new_role'); ?></h4>
        <form  class="crud-ajax-form needs-validation action-ajax-form" action="<?php echo route('member::roles.postCreate'); ?>" method="POST">
            <?php echo csrf_field(); ?>
                            ...
                            <div class="tab-pane <?php echo e($_LOCALE_BASE_CODE == $locale ? 'active' : ''); ?>" id="kt_tabs_<?php echo e($_LOCALE_BASE_CODE); ?>" role="tabpanel">
                                  <div class="col-md-6  mt-3">
                                    ...
                                    'label' => __('member::inputs.title.label') . ' <span class="text-danger"> [' . $_LOCALE_BASE_CODE . '] <span>',
                                        ...
                                        'value'       => old('title[' . $_LOCALE_BASE_CODE . ']'),
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        'attr' => 'data-on-validation-error-click=".lang_tab_'. $_LOCALE_BASE_CODE .'"',
                                        'value'       => old('description[' . $_LOCALE_BASE_CODE . ']')
                                        ]
                                        ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                            </div>
...
<?php echo $__env->make('member::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u587692534/domains/almaknon.com/public_html/Modules/Member/Resources/views/roles/add.blade.php ENDPATH**/ ?>