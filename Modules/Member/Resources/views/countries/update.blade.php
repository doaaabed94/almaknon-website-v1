...
@section('content')
    @component('member::common-components.breadcrumb')
        @slot('title')
           <a href="{!! route('member::CountryController@index') !!}">
   ...
   <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form  class="crud-ajax-form needs-validation action-ajax-form" action="{!! route('member::CountryController@postUpdate', ['model' => $model->id]) !!}" method="POST">
                        {!! csrf_field() !!}
